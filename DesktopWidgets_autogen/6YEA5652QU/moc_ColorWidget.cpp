...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ColorWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ColorWidget_t qt_meta_stringdata_ColorWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ColorWidget[] = {
...
Q_CONSTINIT const QMetaObject ColorWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ColorWidget.offsetsAndSizes,
