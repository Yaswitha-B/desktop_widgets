...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BaseWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BaseWidget_t qt_meta_stringdata_BaseWidget = {
    {
        QT_MOC_LITERAL(0, 10),  // "BaseWidget"
        QT_MOC_LITERAL(11, 20),  // "onDoubleClickTimeout"
        QT_MOC_LITERAL(32, 0)   // ""
    },
    "BaseWidget",
...
Q_CONSTINIT static const uint qt_meta_data_BaseWidget[] = {
...
Q_CONSTINIT const QMetaObject BaseWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_BaseWidget.offsetsAndSizes,
    qt_meta_data_BaseWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BaseWidget_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BaseWidget, std::true_type>,
        // method 'onDoubleClickTimeout'
...
void BaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onDoubleClickTimeout(); break;
        default: ;
        }
    }
    (void)_a;
